<?php
require_once 'DatabaseMocks.php';
...
$userFromGame2 = ['id' => 1, 'login' => 'Игрок из игры 2', 'color' => '#ff0000', 'game' => 2, 'turn_order' => 1, 'turn_status' => 'wait', 'money' => 50, 'age' => 1];
...
echo 'Comparison: ' . (($user && $user->game != $game1['id']) ? 'true' : 'false') . PHP_EOL;
